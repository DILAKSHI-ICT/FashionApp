...
function CategoryScreen8({navigation}) {
  ...
  return (
    <View style={styles.background}>
      ...
      />
      <Text style={styles.text1}>Printed Casual T-Shirt</Text>
      <Text style={styles.text2}>New Arrivals</Text>

      <Text style={styles.text4}>Specification :-</Text>
      <View style={styles.logingButton3}>
        <Text style={styles.text7}>XS</Text>
        
      </View>
      <View style={styles.logingButton4}>
        <Text style={styles.text7}>S</Text>
        
      </View>
      <View style={styles.logingButton5}>
        <Text style={styles.text10}>M</Text>
        
      </View>
      <Text style={styles.text5}>Rs.950.00</Text>
