...
function CategoryScreen5({navigation}) {
  ...
  return (
    <View style={styles.background}>
      ...
      />
      <Text style={styles.text1}>Crew Neck T-Shirt (Slim Fit)</Text>
      ...
      <Text style={styles.text5}>Rs.1950.00</Text>
...
export default CategoryScreen5;