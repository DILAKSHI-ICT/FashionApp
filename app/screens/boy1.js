...
function CategoryScreen4({navigation}) {
  ...
  return (
    <View style={styles.background}>
      ...
      />
      <Text style={styles.text1}>Mandarin Collar T-Shirt</Text>
      ...
      <Text style={styles.text5}>Rs.3950.00</Text>
...
export default CategoryScreen4;